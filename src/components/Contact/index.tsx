...
function Contact() {
     ...
     return (
          <>
               ...
               <div className='py-4 row' style={{ backgroundColor: '#2E135C' }}>
                    ...
                    <div className="col-12 col-md-6 my-5">
                         <div className=' d-flex justify-content-center' style={{}}>
                              <img src={locationImage} alt='personal telephone' style={{ width: '30%' }} />
                              <div className='d-flex flex-column flex-wrap justify-content-around align-items-center'>
                    ...
                    <div className="col-12 col-md-6 my-5">
                         <div className=' d-flex  justify-content-center mb-5'>
                              <img src={telephoneImage} alt='personal telephone' className='w-25' />
                              <div
                    ...
                    <div className="col-12  col-md-6 my-5 ">
                         <div className=' d-flex  justify-content-center mb-5'>
                              <img src={emailImage} alt='personal telephone' style={{ width: '30%' }} className='' />
                              <div className='d-flex flex-column flex-wrap justify-content-center align-items-center'>
                                   ...
                                   <div className="d-flex flex-column align-items-center">
                                        ...
                                        <label style={{ color: 'white' }}>brandox02.dev@gmail.com</label>
                                   </div>
                              </div>
                         </div>
                    </div>
                    <div className="col-12 col-md-6 my-5 mt-0 d-flex justify-content-center align-items-center " >
                         <img src={githubImage} alt='personal telephone' className='' style={{ width: '20%' }} />
                         ...
                         >
                              ...
                              <a style={{ color: 'white' }} href='https://github.com/brandox02' target='_blank' rel='noreferrer'>https://github.com/brandox02</a>
                         </div>
                    </div>
                    <div className="col-12 col-md-6 my-5 mt-0 d-flex justify-content-center align-items-center" >
                         <img src={linkedinImage} alt='personal telephone' className='' style={{ width: '20%' }} />
                         <div className='d-flex flex-column flex-wrap justify-content-around align-items-center w-50'
                              style={{ marginLeft: 20 }}
                         >
               ...
               <img src={darkBorderImage} alt=" dark" style={{ transform: 'rotate(180deg)', marginTop: -22, position: 'relative', width: 'calc(100% + 60px)', right: 13 }} />
